...
*/}
    ...
    function cloneProperty(/* this=prop, */ value, clone) {
      clone[this.name] = ( value && value.clone ) ? value.clone() : value;
    },
    function deepCloneProperty(/* this=prop, */ value, clone) {
      clone[this.name] = ( value && value.deepClone ) ? value.deepClone() : value;
    },
    function exprClone() {
      return this;
    },
