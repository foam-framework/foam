   ...
   methods: {
      ...
      toHTML: function() {
         return '<div class="stackview" style="width:100%;font-size:200%;font-family:sans-serif" id="' + this.getID() + '">' +
            ...
            '<table width=100% style="table-layout:fixed;"><tr><td width2=48% valign=top><div class="stackview-viewarea"></div></td><td width=48% valign=top><div class="stackview-previewarea"></div></td></tr></table></div>';
      },
