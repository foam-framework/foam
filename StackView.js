...
var StackView = FOAM({
  ...
  methods: {
    ...
    toHTML: function() {
      return '<div class="stackview" ' +
          'style="width:100%;font-size:200%;font-family:sans-serif" id="' +
          this.getID() + '">' +
          '<div class="stackview_navbar"></div>' +
          '<div class="stackview_navactions">' + this.backButton.toHTML() +
          this.forwardButton.toHTML() + '</div>' +
          '<table width=100% style="table-layout:fixed;"><tr>' +
          '<td width=100% notwidth2=53% valign=top>' +
          '<div class="stackview-viewarea"></div></td>' +
          '<td notwidth2=43% valign=top>' +
          '<div class="stackview_previewarea"></div></td></tr></table></div>';
    },
    ...
    viewAreaElement: function() {
      return this.$.childNodes[2].childNodes[0].childNodes[0].childNodes[0]
          .childNodes[0];
    },

    previewAreaElement: function() {
      return this.$.childNodes[2].childNodes[0].childNodes[0].childNodes[1]
          .childNodes[0];
    },
