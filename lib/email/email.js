...
MODEL({
  ...
  properties: [
    ...
    },
    {
      ...
      name: 'action',
      preSet: function(_, a) {
        return function(__ctx__, action) {
          var obj = this;
          a.apply(obj, arguments);
          var self = this;
          var sink = action.backOnComplete ?
            { put: function() { __ctx__.stack.back(); },
              error: function() { __ctx__.stack.back(); } } : undefined;
          __ctx__.EMailDAO && __ctx__.EMailDAO.put(obj, sink);
        };
      }
    }
  ]
...
MODEL({
  ...
  actions: [
    ...
    },
    {
      ...
      action: function () {
        var replyMail = this.__ctx__.EMail.create({
          to: [this.from],
    ...
    },
    {
      ...
      action: function () {
        var forwardedMail = this.__ctx__.EMail.create({
          subject: this.subject,
          body: this.body,
          labels: ['DRAFT'],
        });
