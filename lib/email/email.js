...
CLASS({
  ...
  [
    ...
    {
      name: 'iconURL',
      todo: 'This only works in the Navigator/SLICE demo',
  ...
  actions: [
    {
      ...
      delegate: 'foam.lib.email.EMail.REPLY',
      applyOnAll: false
    },
    {
      model_: 'foam.lib.email.ConversationAction',
      delegate: 'foam.lib.email.EMail.REPLY_ALL',
      applyOnAll: false
    },
    {
      model_: 'foam.lib.email.ConversationAction',
      delegate: 'foam.lib.email.EMail.FORWARD',
      applyOnAll: false
    },
    {
      model_: 'foam.lib.email.ConversationAction',
      delegate: 'foam.lib.email.EMail.STAR',
      applyOnAll: false
    },
    {
      model_: 'foam.lib.email.ConversationAction',
      delegate: 'foam.lib.email.EMail.ARCHIVE'
    },
    {
      model_: 'foam.lib.email.ConversationAction',
      delegate: 'foam.lib.email.EMail.SPAM'
    },
    {
      model_: 'foam.lib.email.ConversationAction',
      delegate: 'foam.lib.email.EMail.TRASH'
    },
    {
      model_: 'foam.lib.email.ConversationAction',
      delegate: 'foam.lib.email.EMail.OPEN'
    }
  ]
});
