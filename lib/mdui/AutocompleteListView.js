  ...
  templates: [
    ...
    */},
    function toInnerHTML() {/*
      ...
      <div class="arvBody" id="<%= this.bodyId = this.nextID() %>">
        $$dao{ model_: 'DAOListView', className: 'rows', tagName: 'div', useSelection: true, rowView: { create: this.X.rowView } }
      </div>
    */}
  ],
  ...
  methods: {
    initHTML: function() {
      ...
      if ( this.X.gestureManager ) {
        ...
        // TODO(braden): Native scrolling?
        var target = this.X.GestureTarget.create({
          containerID: this.bodyId,
          handler: self,
