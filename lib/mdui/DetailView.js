MODEL({
  ...
  methods: {
    init: function() {
      ...
      this.__ctx__.registerModel(mdTextFieldView,  'TextFieldView');
      this.__ctx__.registerModel(mdIntFieldView,   'IntFieldView');
      this.__ctx__.registerModel(mdFloatFieldView, 'FloatFieldView');
      this.SUPER();
    },
...
MODEL({
  ...
  properties: [
    ...
    { name: 'softData' },
    { name: 'inputId' },
    { name: '$input', getter: function() { return this.__ctx__.$(this.inputId); } },
    { name: 'labelId' },
    { name: '$label', getter: function() { return this.__ctx__.$(this.labelId); } },
