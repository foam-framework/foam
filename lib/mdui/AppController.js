  ...
  templates: [
    ...
    <div id="<%= this.setClass('searchMode', function() { return self.data.searchMode; }, this.id) %>"  class="mdui-app-controller">
       <div class="header">
         <span class="default">
           $$menu
           <% if ( this.data.createAction ) out(this.createActionView(this.data.createAction, { data: this.data, className: 'composeButton', color: 'white', font: '30px Roboto, Arial', width: 44, height: 44, radius: 22, background: 'red', alpha: 1})); %>
