...
CLASS({
  ...
  properties: [
    { name: 'model', defaultValueFn: function() { return this.FOAMGMailMessage; }, hidden: true, transient: true },
    ...
    { name: 'draftDao', factory: function() { return this.GMailRestDAO.create({ model: this.GMailDraft }); }, hidden: true, transient: true },
    { name: 'localDao', factory: function() { return this.NullDAO.create({ model: this.GMailMessage }); }, hidden: true, transient: true },
    { name: 'historyDao', factory: function() { return this.GMailRestDAO.create({ model: this.GMailHistory }); }, hidden: true, transient: true },
