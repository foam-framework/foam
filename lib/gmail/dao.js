...
CLASS({
  ...
  properties: [
    { name: 'model', defaultValueFn: function() { return this.X.FOAMGMailMessage; }, hidden: true },
    ...
    { name: 'draftDao', factory: function() { return this.X.GMailRestDAO.create({ model: GMailDraft }); }, hidden: true },
    { name: 'localDao', factory: function() { return this.X.NullDAO.create({ model: GMailMessage }); }, hidden: true },

    { name: 'historyDao', factory: function() { return this.X.GMailRestDAO.create({ model: GMailHistory }); }, hidden: true },
    { name: 'lastHistoryId' },
