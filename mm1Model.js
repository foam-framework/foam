       ...
       },
       {
           ...
           defaultValueFn: function() {
             ...
             for (var i = 0, prop; prop = this.properties[i]; i++) {
               ...
               var p;
               var type = ArrayProperty.isInstance(prop) ?
               ...
               switch (type) {
                 ...
                 p = protomessage(prop.prototag,
                     model.protoparser.export('START'));
               }
             ...
             parser.addAction('model', function(a) {
               ...
               for (var i = 0, field; field = a[i]; i++) {
                 ...
                 if (ArrayProperty.isInstance(field[0])) {
                   createArgs[field[0].name] =
                       (createArgs[field[0].name] || []).concat(field[1]);
                 } else {
