...
X.GridView.getPrototype().updateHTML   = OAM.time('GridView.updateHTML',  X.GridView.getPrototype().updateHTML);
...
X.GridByExpr.getPrototype().initHTML   = OAM.time('GridByExpr.initHTML',  X.GridByExpr.getPrototype().initHTML);
