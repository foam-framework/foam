...
CLASS({package: "foam.apps.ctm",name: "TaskManager",requires: ["Binding","PersistentContext","foam.apps.ctm.Task","foam.apps.ctm.TaskController","foam.apps.ctm.TaskHistoryGraph","foam.apps.ctm.TaskManagerContext","foam.apps.ctm.TaskManagerDetailView","foam.dao.EasyDAO","foam.dao.IDBDAO","foam.ui.TableView"],exports: ["clock$","selection$","tasks_ as tasks"],properties: [{model_:"BooleanProperty",name: "clock"},{name: "persistentContext",transient: true,lazyFactory: function () {
        return this.PersistentContext.create({
          dao: this.IDBDAO.create({ model: this.Binding }),
          predicate: NOT_TRANSIENT,
          context: this
        });
      }},{name: "ctx",type: "foam.apps.ctm.TaskManagerContext",transient: true,defaultValue: null,postSet: function (old, nu) {
        if ( old === nu ) return;
        if ( old ) Events.unlink(old.tableColumns$, this.tableColumns$);
        if ( nu ) Events.link(nu.tableColumns$, this.tableColumns$);
      }},{model_:"StringArrayProperty",name: "tableColumns",lazyFactory: function () { return this.Task.tableProperties; }},{name: "queryParser",factory: function () { return QueryParserFactory(this.Task, true); }},{model_:"foam.core.types.DAOProperty",name: "tasks",dynamicValue: function () {
        return this.tasks_.where(
            this.search ?
                (this.queryParser.parseString(this.search) || TRUE) :
                TRUE);
      },view: {factory_: "foam.ui.TableView",scrollEnabled: true}},{model_:"StringProperty",name: "search",transient: true,view: {factory_: "foam.ui.TextFieldView",onKeyMode: true}},{name: "selection",transient: true,defaultValue: null,postSet: function (old, nu) {
        if ( old === nu ) return;
        if ( nu ) {
      ...
      }},{model_:"ArrayProperty",name: "memory",transient: true,view: "foam.apps.ctm.TaskHistoryGraph"},{model_:"ArrayProperty",name: "cpu",transient: true,view: "foam.apps.ctm.TaskHistoryGraph"},{model_:"ArrayProperty",name: "network",transient: true,view: "foam.apps.ctm.TaskHistoryGraph"},{model_:"foam.core.types.DAOProperty",name: "tasks_",transient: true,lazyFactory: function () {
        return this.EasyDAO.create({
          daoType: 'MDAO',
          model: 'foam.apps.ctm.Task'
        });
      }},{name: "taskControllers_",transient: true,factory: function () { return {}; }}],actions: [{name: "kill",label: "End Process",isEnabled: function () { return !!this.selection; },action: function () { this.selection.kill(); }}],methods: [function init() {
    ...
    }],listeners: [{name: "tick",code: function () { this.clock = ! this.clock; this.tick(); },isMerged: 2000}]})
CLASS({package: "foam.apps.ctm",name: "Task",requires: ["foam.graphics.HTMLGraph"],tableProperties: ["name","memory","cpu","network","processId"],properties: [{model_:"IntProperty",name: "id",hidden: true},{model_:"StringProperty",name: "iconUrl",label: "",hidden: true,defaultValue: "https://www.gstatic.com/images/icons/material/product/1x/chrome_16dp.png",view: "foam.ui.ImageView"},{model_:"StringProperty",name: "name",label: "Task",aliases: ["t","task"],tableFormatter: function (name, obj) {
        return '<img src="' + obj.iconUrl + '"><span>' + name + '</span>';
      }},{model_:"FloatProperty",name: "memory",aliases: ["m","mem","mb"],units: "MB",tableFormatter: function (v, obj) {
        return (Math.round(v * 100) / 100) + this.units;
      }},{model_:"FloatProperty",name: "cpu",label: "CPU",aliases: ["c"],units: "%",tableFormatter: function (v, obj) {
        return (Math.round(v * 100) / 100) + this.units;
      }},{model_:"FloatProperty",name: "network",aliases: ["n","net","b","bandwidth"],units: "B/s",tableFormatter: function (v, obj) {
        return (Math.round(v * 100) / 100) + this.units;
      }},{model_:"IntProperty",name: "processId",label: "Process ID",aliases: ["p","pid","procid"]}],actions: [{name: "kill",label: "End Process",action: function () {
...
CLASS({package: "foam.graphics",name: "HTMLGraph",extendsModel: "foam.ui.SimpleView",properties: [{model_:"ColorProperty",name: "graphColor",defaultValue: "green"},{model_:"ColorProperty",name: "backgroundColor",defaultValue: "transparent"},{model_:"ArrayProperty",name: "data",lazyFactory: function () { return []; },preSet: function (old, nu) {
        if ( old === nu ) return nu;
        if ( nu.length > this.width ) return nu.slice(-this.width);
        return nu;
      }},{model_:"IntProperty",name: "width",defaultValue: 40},{model_:"IntProperty",name: "height",defaultValue: 15},{model_:"FloatProperty",name: "min",defaultValueFn: function () {
      ...
      }},{model_:"FloatProperty",name: "max",defaultValueFn: function () {
      ...
      }}],methods: [function addData(value, opt_maxNumValues) {
...
'">\n        ');
 for ( var i = 0; i < this.data.length; ++i ) {
             ...
             var bgHeight = 100 - dataHeight; ;out('\n          <graph-row style="width: ',
escapeHTML(rowWidth),
'%">\n            <graph-row-bg style="background: ',
escapeHTML(this.backgroundColor),
'; flex-grow: ',
escapeHTML(bgHeight),
'"></graph-row-bg>\n            <graph-row-data style="background: ',
escapeHTML(this.graphColor),
'; flex-grow: ',
escapeHTML(dataHeight),
'"></graph-row-data>\n          </graph-row>\n        ');
 } ;out('\n      </graph>\n    ');return out.toString();}},{name: "CSS",code: ConstantTemplate("\ngraph {\nflex-grow: 1;\ndisplay: flex;\nalign-items: stretch;\nalign-content: stretch;\n}\ngraph-row {\ndisplay: flex;\nflex-direction: column;\nalign-items: stretch;\nalign-content: stretch;\n}\ngraph-row-bg {\ndisplay: block;\nflex-grow: 1;\n}\ngraph-row-data {\ndisplay: block;\nmin-height: 1px;\n}\n")}]})
...
CLASS({package: "foam.ui",name: "HTMLViewTrait",label: "HTMLView",requires: ["foam.input.touch.GestureTarget","foam.ui.ActionBorder","foam.ui.PropertyView","foam.ui.AsyncLoadingView"],properties: [{name: "id",label: "Element ID",type: "String",factory: function () { return this.instance_.id || this.nextID(); }},{model_:"foam.core.types.DocumentInstallProperty",name: "installCSS",documentInstallFn: function (X) {
      ...
      },defaultValue: false},{name: "preferredWidth",defaultValue: 400},{name: "preferredHeight",defaultValue: 40}],constants: [{name: "KEYPRESS_CODES",value: {"8": true,"33": true,"34": true,"37": true,"38": true,"39": true,"40": true}},{name: "ON_HIDE",value: ["onHide"]},{name: "ON_SHOW",value: ["onShow"]}],methods: [function strToHTML(str) {
      /*
...
CLASS({package: "foam.ui",name: "BaseView",extendsModel: "foam.patterns.ChildTreeTrait",properties: [{name: "data"}],methods: [function addDataChild(child) {
...
CLASS({package: "foam.patterns",name: "ChildTreeTrait",properties: [{name: "parent",type: "foam.patterns.ChildTreeTrait",hidden: true},{name: "children",type: "Array[foam.patterns.ChildTreeTrait]",factory: function () { return []; }}],methods: [function onAncestryChange_() {
...
CLASS({package: "foam.core.types",name: "DocumentInstallProperty",extendsModel: "Property",properties: [{model_:"FunctionProperty",name: "documentInstallFn"}],methods: [function initPropertyAgents(proto, fastInit) {
...
CLASS({package: "foam.apps.ctm",name: "TaskController",requires: ["foam.apps.ctm.History","foam.apps.ctm.Task","foam.apps.ctm.TaskSimulator"],imports: ["tasks"],properties: [{model_:"foam.core.types.DAOProperty",name: "tasks"},{name: "task",type: "foam.apps.ctm.Task",factory: function () {
        return this.RANDOM_TASK();
      },postSet: function (old, nu) {
        if ( old === nu ) return;
        this.simulator.task = nu;
      }},{model_:"IntProperty",name: "numHistoryItems",hidden: true,defaultValue: 64},{name: "simulator",type: "foam.apps.ctm.TaskSimulator",factory: function () {
        return this.TaskSimulator.create({
          task: this.task,
          onTaskUpdate: this.onTaskUpdate
        }, this.Y);
      }},{name: "memory",type: "foam.apps.ctm.History",factory: function () {
        return this.History.create({
          property: this.Task.MEMORY,
          data: this.task,
          numItems: this.numHistoryItems
        }, this.Y);
      }},{name: "cpu",type: "foam.apps.ctm.History",factory: function () {
        return this.History.create({
          property: this.Task.CPU,
          data: this.task,
          numItems: this.numHistoryItems
        }, this.Y);
      }},{name: "network",type: "foam.apps.ctm.History",factory: function () {
        return this.History.create({
          property: this.Task.NETWORK,
          data: this.task,
          numItems: this.numHistoryItems
        }, this.Y);
      }}],constants: [{name: "WORDS",value: ["Browser","Extension","Tab","App","Plugin","Google","GMail","Calendar","Docs","Ads","Todo","Meta"]},{name: "RANDOM_TASK",value: function () {
      ...
      return task;
    }}],listeners: [{name: "onTaskUpdate",code: function () { this.tasks && this.tasks.put(this.task); }}]})
CLASS({package: "foam.apps.ctm",name: "History",imports: ["clock$"],properties: [{name: "data"},{name: "property",postSet: function (old, nu) {
        if ( old === nu ) return;
        if ( old ) old.removeListener(this.onUpdate);
        if ( nu ) nu.addListener(this.onUpdate);
      }},{model_:"IntProperty",name: "numItems",defaultValue: 64},{model_:"ArrayProperty",name: "history",preSet: function (_, nu) { return nu ? nu.sink : nu; },factory: function () { return [].sink; }}],methods: [function init() {
      this.SUPER();
      this.clock$.addListener(this.onUpdate);
    }],listeners: [{name: "onUpdate",code: function () {
        var value = this.data[this.property.name];
        if ( this.history.length === this.numItems ) this.history.shift();
        this.history.put(value);
      }}]})
CLASS({package: "foam.apps.ctm",name: "TaskSimulator",imports: ["clock$"],properties: [{name: "task",type: "foam.apps.ctm.Task",required: true},{model_:"FunctionProperty",name: "onTaskUpdate",defaultValue: function () {}}],methods: [function init() {
      this.SUPER();
      this.clock$.addListener(this.tick);
    }],listeners: [{name: "tick",code: function () {
        // Memory.
        if ( Math.random() > 0.8 ) {
          if ( Math.random() > 0.5 ) {
...
CLASS({package: "foam.dao",name: "FutureDAO",extendsModel: "foam.dao.ProxyDAO",properties: [{name: "delegate",factory: function () { return null; },postSet: function (oldDAO, newDAO) {
      ...
      }},{name: "future",required: true},{name: "model",defaultValueFn: function () { return this.delegate ? this.delegate.model : ''; }}],methods: [function init() { /* Sets up the future to provide us with the delegate when it becomes available. */
      this.SUPER();
...
CLASS({package: "foam.dao",name: "ProxyDAO",extendsModel: "AbstractDAO",requires: ["foam.dao.NullDAO"],properties: [{name: "delegate",type: "DAO",mode: "read-only",required: true,hidden: true,transient: true,factory: function () { return this.NullDAO.create(); },postSet: function (oldDAO, newDAO) {
      ...
      }},{model_:"ModelProperty",name: "model",defaultValueFn: function () { return this.delegate.model; },type: "Model"}],methods: [function relay() { /* Sets up relay for listening to delegate changes. */
      if ( ! this.relay_ ) {
        var self = this;
...
CLASS({package: "foam.dao",name: "NullDAO",methods: [function put(obj, sink) { sink && sink.put && sink.put(obj); },function remove(obj, sink) { sink && sink.remove && sink.remove(obj); },function select(sink) {
    ...
    },function find(q, sink) { sink && sink.error && sink.error('find', q); },function listen() {},function removeAll() {},function unlisten() {},function pipe() {},function where() { return this; },function limit() { return this; },function skip() { return this; }],help: "A DAO that stores nothing and does nothing."})
CLASS({package: "foam.apps.ctm",name: "TaskHistoryGraph",extendsModel: "foam.ui.SimpleView",requires: ["foam.graphics.Graph"],properties: [{name: "data",postSet: function (old, nu) {
        if ( old === nu ) return;
        if ( nu ) this.graph.data = nu;
        else      this.graph.data = [].sink;
      }},{name: "taskManager",type: "foam.apps.ctm.TaskManager"},{name: "width",defaultValue: 100},{name: "height",defaultValue: 50},{name: "maxValue",defaultValue: -1},{name: "graph",type: "foam.graphics.Graph",lazyFactory: function () {
...
CLASS({package: "foam.graphics",name: "Graph",extendsModel: "foam.graphics.CView",properties: [{name: "style",type: "String",view: {factory_: "foam.ui.ChoiceView",choices: ["Bar","Line","Point"]},defaultValue: "Line"},{model_:"ColorProperty",name: "graphColor",defaultValue: "green"},{model_:"ColorProperty",name: "backgroundColor",defaultValue: ""},{name: "lineWidth",defaultValue: 6},{model_:"BooleanProperty",name: "drawShadow",defaultValue: true},{model_:"ColorProperty",name: "capColor",defaultValue: ""},{model_:"ColorProperty",name: "axisColor",defaultValue: "black"},{model_:"ColorProperty",name: "gridColor",defaultValue: "",type: "String"},{name: "axisSize",type: "int",defaultValue: 2},{name: "xAxisInterval",type: "int",defaultValue: 0},{name: "yAxisInterval",type: "int",defaultValue: 0},{name: "maxValue",label: "Maximum Value",type: "float",defaultValue: -1},{name: "data",type: "Array[float]",factory: function () { return []; },postSet: function (old, nu) {
    ...
    },function paintPointData(canvas, x, y, xs, w, h, maxValue) {
    ...
    },function paintBarData(canvas, x, y, xs, w, h, maxValue) {
      canvas.fillStyle = this.graphColor;
      ...
      if ( this.data.length == maxNumValues ) this.data.shift();
      this.data.push(value);
    },function watch(value, opt_maxNumValues) {
      var graph = this;

      value.addListener(function() {
        graph.addData(value.get(), opt_maxNumValues);
      });
    }],listeners: [{name: "onDataChange",code: function () { this.view && this.view.paint(); }}]})
CLASS({package: "foam.graphics",name: "CView",label: "CView",traits: ["foam.patterns.ChildTreeTrait"],requires: ["foam.graphics.PositionedCViewView","foam.graphics.CViewView"],properties: [{name: "view",type: "Canvas2",hidden: true,transient: true,postSet: function (_, view) {
        for ( var key in this.children ) {
          var child = this.children[key];
          child.view = view;
          if ( view ) child.addListener(view.paint);
        }
      }},{name: "canvas",hidden: true,transient: true,getter: function () { return this.view && this.view.canvas; }},{name: "$",hidden: true,transient: true,getter: function () { return this.view && this.view.$; }},{name: "state",defaultValue: "initial"},{model_:"BooleanProperty",name: "suspended",defaultValue: false},{name: "className",defaultValue: "",postSet: function () {
        if ( ! this.$ ) return;
        this.$.className = this.className;
      },help: "CSS class name(s), space separated. Used if adapted with a CViewView."},{model_:"FloatProperty",name: "x",defaultValue: 0},{model_:"FloatProperty",name: "y",defaultValue: 0},{model_:"FloatProperty",name: "a",label: "Rotation",defaultValue: 0},{model_:"FloatProperty",name: "scaleX",defaultValue: 1},{model_:"FloatProperty",name: "scaleY",defaultValue: 1},{name: "canvasX",getter: function () { return this.x + ( this.parent ? this.parent.canvasX : 0 ); }},{name: "canvasY",getter: function () { return this.y + ( this.parent ? this.parent.canvasY : 0 ); }},{model_:"IntProperty",name: "width",defaultValue: 10},{model_:"IntProperty",name: "height",defaultValue: 10},{model_:"FloatProperty",name: "alpha",defaultValue: 1},{name: "color",label: "Foreground Color",type: "String",defaultValue: "black"},{name: "background",label: "Background Color",type: "String",defaultValue: "white"},{name: "font"},{model_:"BooleanProperty",name: "clipped",defaultValue: false}],methods: [function toView_() { /* Internal. Creates a CViewView wrapper. */
      if ( ! this.view ) {
      ...
      return this.view;
          ...
          to 'active' '$$DOC{ref:'.state'}. */ },function write(document) { /* Inserts this $$DOC{ref:'foam.graphics.CView'} into the DOM
      ...
      return this;
    },function erase() { /* Wipes the canvas area of this $$DOC{ref:'.'}. Primarily used
    ...
    },function paintChildren() { /* Paints each child. */
      for ( var i = 0 ; i < this.children.length ; i++ ) {
        var child = this.children[i];
        this.canvas.save();
    ...
    },function paintSelf() { /* Implement this in sub-models to do your painting. */ },function paint() { /* Translates the canvas to our ($$DOC{ref:'.x'}, $$DOC{ref:'.y'}),
...
CLASS({package: "foam.graphics",name: "PositionedCViewView",extendsModel: "foam.graphics.AbstractCViewView",traits: ["foam.ui.layout.PositionedDOMViewTrait"],properties: [{name: "tagName",factory: function () { return 'canvas'; }}],methods: [function init() {
      this.SUPER();
      this.X.dynamic(function() {
...
CLASS({package: "foam.ui.layout",name: "PositionedViewTrait",properties: [{model_:"FloatProperty",name: "x",units: "px",defaultValue: 0},{model_:"FloatProperty",name: "y",units: "px",defaultValue: 0},{model_:"FloatProperty",name: "z",units: "px",defaultValue: 0},{model_:"IntProperty",name: "width",units: "px",defaultValue: 100},{model_:"IntProperty",name: "height",units: "px",defaultValue: 100},{model_:"IntProperty",name: "preferredWidth",units: "px",defaultValue: 100},{model_:"IntProperty",name: "preferredHeight",units: "px",defaultValue: 100}]})
CLASS({package: "foam.graphics",name: "AbstractCViewView",extendsModel: "foam.ui.View",properties: [{name: "cview",type: "foam.graphics.CView",postSet: function (_, cview) {
        cview.view  = this;
        this.width  = cview.x + cview.width;
        this.height = cview.y + cview.height;
      }},{name: "className",defaultValue: "",help: "CSS class name(s), space separated."},{model_:"FloatProperty",name: "scalingRatio",preSet: function (_, v) { return v <= 0 ? 1 : v ; },defaultValue: 1},{name: "speechLabel"},{name: "role"},{name: "tabIndex"},{model_:"IntProperty",name: "width",defaultValue: 100},{model_:"IntProperty",name: "height",defaultValue: 100},{name: "canvas",getter: function () {
...
CLASS({package: "foam.ui",name: "DestructiveDataView",extendsModel: "foam.ui.BaseView",requires: ["SimpleValue"],properties: [{name: "data",preSet: function (old,nu) {
      ...
      }},{name: "dataLinkedChildren",type: "Array[foam.patterns.ChildTreeTrait]",factory: function () { return []; }}],methods: [function shouldDestroy(old,nu) {
...
CLASS({package: "foam.graphics",name: "CViewView",extendsModel: "foam.graphics.AbstractCViewView",properties: [{name: "cview",postSet: function (_, cview) {
        cview.view = this;
        this.X.dynamic(function() {
...
CLASS({package: "foam.apps.ctm",name: "TaskManagerContext",requires: ["foam.apps.ctm.Task"],properties: [{model_:"StringArrayProperty",name: "tableColumns",factory: function () { return this.Task.tableProperties; }}]})
CLASS({package: "foam.apps.ctm",name: "TaskManagerDetailView",extendsModel: "foam.ui.DetailView",requires: ["foam.apps.ctm.Task","foam.apps.ctm.TaskPieGraph","foam.ui.ActionButton"],properties: [{model_:"IntProperty",name: "numHistoryItems",defaultValue: 64},{model_:"BooleanProperty",name: "showActions",preSet: function () { return false; },defaultValue: false}],templates: [{name: "toHTML",code: function (opt_out){var self = this, X = this.X, Y = this.Y;var out = opt_out ? opt_out : TOC(this);out('\n      <task-manager>\n        <tm-header>\n          <label>Search:</label>', self.createTemplateView('search'),
'\n        </tm-header>\n        <tm-body>\n          ', self.createTemplateView('tasks', {
            editColumnsEnabled: true,
            properties$: this.data.tableColumns$
          }),
'\n        </tm-body>\n        <tm-footer>\n          <stats>\n            <global-stats>\n              ', self.createTemplateView('tasks', { model_: this.TaskPieGraph, property: this.Task.MEMORY }),
'\n              ', self.createTemplateView('tasks', { model_: this.TaskPieGraph, property: this.Task.CPU }),
'\n              ', self.createTemplateView('tasks', { model_: this.TaskPieGraph, property: this.Task.NETWORK }),
'\n            </global-stats>\n            <local-stats id="',
 this.setClass('hidden', function() { return !this.data || !this.data.selection; }.bind(this)) ,
'">\n              ', self.createTemplateView('memory', { width: 100, height: 50 }),
'\n              ', self.createTemplateView('cpu', { width: 100, height: 50 }),
'\n              ', self.createTemplateView('network', { width: 100, height: 50 }),
'\n            </local-stats>\n          </stats>\n          <actions>\n            <a target="_blank" href="chrome://memory-redirect">Stats for nerds</a>\n            ', self.createTemplateView('kill'),
...
CLASS({package: "foam.apps.ctm",name: "TaskPieGraph",extendsModel: "foam.ui.SimpleView",requires: ["foam.graphics.PieGraph"],imports: ["selection$","clock$"],properties: [{name: "selection",postSet: function () { this.paint(); }},{name: "property",required: true},{name: "groups"},{name: "pie",type: "foam.graphics.PieGraph",lazyFactory: function () {
      ...
      },isFramed: true}],templates: [{name: "toHTML",code: function (opt_out){var self = this, X = this.X, Y = this.Y;var out = opt_out ? opt_out : TOC(this);out(' ',
 self.pie,
' ');return out.toString();}}]})
CLASS({package: "foam.graphics",name: "PieGraph",extendsModel: "foam.graphics.CView",properties: [{name: "r",type: "int",view: "foam.ui.IntFieldView",defaultValue: 50,postSet: function (old, nu) {
        if ( old === nu ) return;
        this.setDimensions();
      }},{name: "lineColor",type: "String",defaultValue: "white"},{name: "lineWidth",type: "int",defaultValue: 1,postSet: function (old, nu) {
        if ( old === nu ) return;
        this.setDimensions();
      }},{name: "colorMap",defaultValue: ""},{name: "data",type: "Array[float]",factory: function () { return []; }},{name: "groups",label: "Group Data",defaultValue: {}},{model_:"FunctionProperty",name: "toColor",defaultValue: function (key, i, n) {
...
CLASS({package: "foam.ui",name: "ActionButton",extendsModel: "foam.ui.BaseView",traits: ["foam.ui.HTMLViewTrait"],properties: [{name: "action",postSet: function (old, nu) {
        ...
        return this.data ?
            ...
            this.action.label;
      }},{name: "iconUrl",defaultValueFn: function () { return this.action.iconUrl; }},{name: "tooltip",defaultValueFn: function () { return this.action.help; }}],methods: [function toHTML() {
      ...
      return out;
    },function initKeyboardShortcuts() { /* Not needed, will be done by parent View. */ }],listeners: [{name: "render",code: function () { this.updateHTML(); },isFramed: true}]})
...
CLASS({package: "foam.ui",name: "TextFieldView",label: "Text Field",extendsModel: "foam.ui.SimpleView",requires: ["foam.ui.AutocompleteView"],properties: [{model_:"StringProperty",name: "name",defaultValue: "field"},{model_:"IntProperty",name: "displayWidth",defaultValue: 30},{model_:"IntProperty",name: "displayHeight",defaultValue: 1},{model_:"StringProperty",name: "type",defaultValue: "text"},{model_:"StringProperty",name: "placeholder",defaultValue: ""},{model_:"BooleanProperty",name: "onKeyMode",getter: function () {
      ...
      }},{model_:"BooleanProperty",name: "autocomplete",defaultValue: true},{name: "autocompleter"},{name: "autocompleteView"}],constants: [{name: "ESCAPE",value: ["escape"]},{name: "DONE_EDITING",value: "DONE_EDITING"},{name: "EACH_KEYSTROKE",value: "EACH_KEYSTROKE"},{name: "ENTER_ONLY",value: "ENTER_ONLY"}],methods: [function toHTML() {
...
' style="position:absolute">',
 this.view ,
'</div></span>\n    ');return out.toString();}}],help: "Default autocomplete popup."})
CLASS({package: "foam.ui",name: "PopupView",extendsModel: "foam.ui.SimpleView",properties: [{name: "view",type: "foam.ui.View"},{name: "x"},{name: "y"},{name: "width",defaultValue: ""},{name: "maxWidth",defaultValue: ""},{name: "maxHeight",defaultValue: ""},{name: "height",defaultValue: ""}],methods: [function open(_, opt_delay) {
      if ( this.$ ) return;
...
CLASS({package: "foam.ui",name: "IntFieldView",extendsModel: "foam.ui.AbstractNumberFieldView",methods: [function textToValue(text) { return parseInt(text) || '0'; },function valueToText(value) { return value ? value : '0'; }]})
CLASS({package: "foam.ui",name: "AbstractNumberFieldView",extendsModel: "foam.ui.TextFieldView",properties: [{name: "type",defaultValue: "number"},{name: "step"}],methods: [function extraAttributes() {
      return this.step ? ' step="' + this.step + '"' : '';
    }]})
CLASS({package: "foam.ui",name: "FloatFieldView",extendsModel: "foam.ui.AbstractNumberFieldView",properties: [{name: "precision",defaultValue: ""}],methods: [function formatNumber(val) {
      if ( ! val ) return '0';
...
' ');return out.toString();}}]})
CLASS({package: "foam.dao",name: "EasyDAO",extendsModel: "foam.dao.ProxyDAO",requires: ["MDAO","foam.core.dao.MigrationDAO","foam.core.dao.StorageDAO","foam.dao.CachingDAO","foam.dao.GUIDDAO","foam.dao.SeqNoDAO","foam.dao.ContextualizingDAO","foam.core.dao.CloningDAO"],properties: [{name: "name",defaultValueFn: function () { return this.model.plural; }},{model_:"BooleanProperty",name: "seqNo",defaultValue: false},{model_:"BooleanProperty",name: "guid",label: "GUID",defaultValue: false},{name: "seqProperty",type: "Property"},{model_:"BooleanProperty",name: "cache",defaultValue: false},{model_:"BooleanProperty",name: "logging",defaultValue: false},{model_:"BooleanProperty",name: "timing",defaultValue: false},{model_:"BooleanProperty",name: "contextualize",defaultValue: false},{model_:"BooleanProperty",name: "cloning",defaultValue: false},{name: "daoType",defaultValue: "foam.dao.IDBDAO"},{model_:"BooleanProperty",name: "autoIndex",defaultValue: false},{model_:"ArrayProperty",name: "migrationRules",subType: "foam.core.dao.MigrationRule"}],constants: [{name: "ALIASES",value: {IDB: "foam.dao.IDBDAO",LOCAL: "foam.core.dao.StorageDAO",SYNC: "foam.core.dao.StorageDAO"}}],methods: [function init(args) {
      /*
...
CLASS({package: "foam.core.dao",name: "MigrationDAO",extendsModel: "foam.dao.ProxyDAO",requires: ["foam.core.dao.MigrationRule","foam.dao.FutureDAO","foam.dao.DAOVersion"],imports: ["daoVersionDao"],properties: [{name: "delegate"},{model_:"ArrayProperty",name: "rules",subType: "foam.core.dao.MigrationRule"},{name: "name"}],methods: [function init() {
...
CLASS({package: "foam.dao",name: "CachingDAO",extendsModel: "foam.dao.ProxyDAO",requires: ["foam.dao.FutureDAO"],properties: [{name: "src"},{name: "cache",getter: function () { return this.delegate },setter: function (dao) { this.delegate = dao; },help: "Alias for delegate."},{name: "model",defaultValueFn: function () { return this.src.model || this.cache.model; }}],methods: [function init() {
      this.SUPER();
    ...
    },function put(obj, sink) { this.src.put(obj, sink); },function remove(query, sink) { this.src.remove(query, sink); },function removeAll(sink, options) { return this.src.removeAll(sink, options); }]})
...
CLASS({package: "foam.dao",name: "SeqNoDAO",label: "foam.dao.SeqNoDAO",extendsModel: "foam.dao.ProxyDAO",properties: [{name: "property",type: "Property",required: true,hidden: true,transient: true,defaultValueFn: function () {
        return this.delegate.model ? this.delegate.model.ID : undefined;
      }},{model_:"IntProperty",name: "sequenceValue",defaultValue: 1}],methods: [function init() {
      this.SUPER();
...
CLASS({package: "foam.dao",name: "ContextualizingDAO",extendsModel: "foam.dao.ProxyDAO",methods: [function find(id, sink) {
      var X = this.Y;
...
CLASS({package: "foam.core.dao",name: "CloningDAO",extendsModel: "foam.dao.ProxyDAO",properties: [{model_:"BooleanProperty",name: "onSelect",defaultValue: false}],methods: [function select(sink, options) {
...
CLASS({package: "foam.dao",name: "IDBDAO",label: "IndexedDB DAO",extendsModel: "AbstractDAO",properties: [{name: "model",type: "Model",required: true},{name: "name",label: "Store Name",type: "String",defaultValueFn: function () {
        return this.model.plural;
      }},{model_:"BooleanProperty",name: "useSimpleSerialization",defaultValue: true},{model_:"StringArrayProperty",name: "indicies"}],methods: [function init() {
      this.SUPER();
      ...
      return this;
    }],listeners: [{name: "updated",code: function (evt) {
        console.log('updated: ', evt);
        this.publish('updated');
      }}]})
CLASS({package: "foam.ui",name: "TableView",label: "Table View",extendsModel: "foam.ui.AbstractDAOView",requires: ["foam.graphics.ScrollCView","foam.ui.EditColumnsView","foam.input.touch.GestureTarget"],imports: ["selection$ as hardSelection$"],properties: [{name: "model",type: "Model",defaultValueFn: function () { return this.X.model ||
                                   ( this.data && this.data.model ); }},{model_:"StringArrayProperty",name: "properties",postSet: function () { this.repaint(); }},{name: "hardSelection",postSet: function (_, v) { this.publish(this.ROW_SELECTED, v); }},{name: "selection"},{name: "children",type: "Array[View]",factory: function () { return []; }},{name: "sortOrder",type: "Comparator",defaultValue: "",postSet: function () { this.repaint(); }},{name: "rows",type: "Int",defaultValue: 50,postSet: function (oldValue, newValue) {
        if ( oldValue !== newValue ) this.repaint();
      }},{model_:"IntProperty",name: "height"},{model_:"BooleanProperty",name: "scrollEnabled",defaultValue: false},{model_:"BooleanProperty",name: "columnResizeEnabled",defaultValue: false},{model_:"BooleanProperty",name: "editColumnsEnabled",defaultValue: false},{name: "scrollbar",type: "ScrollCView",factory: function () {
      ...
      }},{name: "scrollPitch",defaultValue: 10,help: "Number of (CSS) pixels of touch drag required to scroll by one"},{name: "touchPrev",hidden: true,transient: true,defaultValue: 0},{model_:"ArrayProperty",name: "selectionListeners_",lazyFactory: function () { return []; }},{model_:"ArrayProperty",name: "hardSelectionListeners_",lazyFactory: function () { return []; }}],actions: [{name: "selectRow",action: function () {
        if ( this.selection ) this.hardSelection = this.selection;
        this.publish(this.CLICK, this.selection);
      },keyboardShortcuts: [13]},{name: "prevRow",action: function () {
        ...
        this.repaint();
      },keyboardShortcuts: [38,75]},{name: "nextRow",action: function () {
        if ( ! this. objs || ! this.objs.length ) return;
        if ( ! this.selection && this.hardSelection ) this.selection = this.hardSelection;
        if ( this.selection ) {
          var i = this.objs.indexOf(this.selection);
        ...
        this.repaint();
      },keyboardShortcuts: [40,74]}],constants: [{name: "MIN_COLUMN_SIZE",value: 5},{name: "ROW_SELECTED",value: ["escape"]},{name: "CLICK",value: "click"},{name: "DOUBLE_CLICK",value: "double-click"}],methods: [function toHTML() {
      ...
      */
      ...
      return str.join('');
    },function columnResizerToHTML(prop1, prop2) {
      var id = this.nextID();
    ...
    }],listeners: [{name: "onResize",code: function () {
        if ( ! this.$ ) return;
...
//        this.scrollbar.extent = rows;
      ...
      },isMerged: 200},{name: "onDAOUpdate",code: function () {
        this.dao.select(COUNT())(function(c) {
          this.scrollbar.size = c.count;
          this.repaint();
        }.bind(this));
      },isFramed: true},{name: "repaint",code: function () { this.repaintNow(); },isFramed: true},{name: "onEditColumns",code: function (evt) {
        ...
        v.initHTML();
      }},{name: "verticalScrollStart",code: function (dy, ty, y) {
        this.touchPrev = y;
      }},{name: "verticalScrollMove",code: function (dy, ty, y) {
...
CLASS({package: "foam.graphics",name: "ScrollCView",extendsModel: "foam.graphics.CView",properties: [{name: "vertical",type: "boolean",defaultValue: true},{model_:"IntProperty",name: "value",preSet: function (_, value) { return Math.max(0, Math.min(this.size-this.extent, value)); },help: "The first element being shown, starting at zero.",defaultValue: 0},{model_:"IntProperty",name: "extent",help: "Number of elements shown.",defaultValue: 10},{model_:"IntProperty",name: "size",postSet: function (_, size) {
        this.value = this.value; // force range checking on value
        this.paint();
      },help: "Total number of elements being scrolled through.",defaultValue: 0},{name: "minHandleSize",type: "int",defaultValue: 10,help: "Minimum size to make the drag handle."},{name: "startY",type: "int",defaultValue: 0},{name: "startValue",type: "int",defaultValue: 0,help: "Starting value or current drag operation."},{name: "handleColor",type: "String",defaultValue: "rgb(107,136,173)"},{name: "borderColor",type: "String",defaultValue: "#555"}],methods: [function initCView() {
      ...
      c.fillRect(
        ...
        this.width - 11,
        this.y + 4 + handleSize);
    }],listeners: [{name: "mouseDown",code: function (e) {
      ...
      }},{name: "touchMove",code: function (e) {
...
CLASS({package: "foam.ui",name: "EditColumnsView",extendsModel: "foam.ui.View",properties: [{name: "model",type: "Model"},{model_:"StringArrayProperty",name: "properties"},{model_:"ArrayProperty",name: "availableProperties"}],methods: [function toHTML() {
      ...
      return s;
    }],listeners: [{name: "onAddColumn",code: function (propName) {
      ...
      }},{name: "onRemoveColumn",code: function (prop) {
        this.properties = this.properties.deleteF(prop);
      }}]})
CLASS({package: "foam.ui",name: "AbstractDAOView",extendsModel: "foam.ui.SimpleView",exports: ["dao$ as daoViewCurrentDAO$"],properties: [{name: "data",postSet: function (oldDAO, dao) {
        if ( this.dao !== dao ) {
          this.dao = dao;
        }
