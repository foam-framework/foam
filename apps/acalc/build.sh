...
cd ../../
node --harmony tools/foam.js foam.build.BuildApp controller=Calc defaultView=foam.apps.calc.CalcView coreFiles=stdlib,async,parse,event,JSONUtil,XMLUtil,context,JSONParser,TemplateUtil,../apps/acalc/Opt,FOAM,FObject,BootstrapModel,mm1Model,mm2Property,mm3Types,mm4Method,mm5Misc,value,view,AbstractDAOView,DAOListView,DetailView,HTMLParser,visitor,dao,arrayDAO,touch,../js/foam/ui/Window,../js/foam/i18n/Visitor,../js/foam/i18n/MessagesBuilder,../js/foam/i18n/GlobalController,../js/foam/i18n/ChromeMessagesExtractor,../js/foam/i18n/ChromeMessagesBuilder extraFiles=../apps/acalc/Calc "targetPath=$BUILD_DIR" precompileTemplates
