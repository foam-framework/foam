...
cd ../../
node --harmony tools/foam.js foam.build.BuildApp controller=Calc defaultView=foam.apps.calc.CalcView coreFiles=stdlib,async,parse,event,JSONUtil,XMLUtil,context,JSONParser,TemplateUtil,../apps/acalc/Opt,FOAM,FObject,BootstrapModel,mm1Model,mm2Property,mm3Types,mm4Method,mm5Misc,value,view,../js/foam/ui/AbstractDAOView,../js/foam/ui/DAOListView,../js/foam/ui/DetailView,HTMLParser,visitor,dao,arrayDAO,../js/foam/ui/Window,../js/foam/i18n/IdGenerator,../js/foam/i18n/Visitor,../js/foam/i18n/MessagesExtractor,../js/foam/i18n/ChromeMessagesInjector,../js/foam/i18n/GlobalController extraFiles=../apps/acalc/Calc "targetPath=$BUILD_DIR" precompileTemplates
