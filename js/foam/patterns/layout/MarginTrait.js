...
CLASS({
  ...
  methods: {
    init: function() {
      ...
      this.horizontalConstraints = this.X.foam.patterns.layout.MarginTrait.MarginProxy.create({},this.X);
      this.verticalConstraints = this.X.foam.patterns.layout.MarginTrait.MarginProxy.create({},this.X);
