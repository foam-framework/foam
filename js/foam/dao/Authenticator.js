...
__DATA({
  ...
  documentation: function() {/*
    ...
    $$DOC{ref:'foam.dao.AuthenticatedDAO.authenticator'} property of an
    $$DOC{ref:'foam.dao.AuthenticatedDAO'}.</p>
    <p>Care should be taken in implementing an Authenticator to ensure that each
