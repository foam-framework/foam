...
//      this.addGroup(Medal.YEAR, 'toYear',   {label: 'To',   op: LTE});
      this.fromYear = this.searchMgr.add(this.DateSearchView.create({op: GTE, label: 'From'}));
      this.toYear   = this.searchMgr.add(this.DateSearchView.create({op: LTE, label: 'To'}));
