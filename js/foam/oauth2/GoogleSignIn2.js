...
CLASS({
  ...
  properties: [
    ...
    },
    {
      name: 'authToken_',
      factory: function() {
        return this.GoogleSignInTokenCarrier.create();
      }
    },
    {
      name: 'done',
  ...
  methods: [
    ...
    // Decorator for WebSocket.send
    function envelope(decorator, delegate, args) {
      var msg = delegate.apply(this, args);
      msg['x-foam-auth'] = decorator.authToken_.token;
      return msg;
    }
  ],
      ...
      templates: [
        function toHTML() {/*
          <div id="%%id" %%cssClassAttr()>
            <div style="margin-bottom: 8px;">Press the button below to sign in with your Google account.</div>
