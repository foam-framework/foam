...
console.log(p.parseString('<div id="foo" onclick="foo"><i>italic</i><% if ( true ) { %><b>bold   </b><% } %><span>span</span></div>'));
// DEBUG_PARSE = true;
console.log(p.parseString('<div onclick="foo" id="bar">bar</div>'));
